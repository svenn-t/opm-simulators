 ...
 * matching Dune::MultiTypeBlockVector.  There is therefore nothing to split or
 * copy here: the Krylov solver operates directly on what the linearizer
 * assembled, and the diagonal blocks the block preconditioner passes to its
 * sub-solvers are exactly the scalar matrices Hypre requires.
 */
                              ...
                              GetPropType<TypeTag, Properties::GlobalEqVectorTPSA> >
{
    ...
    //! \brief The five-field view the solver and preconditioner see.
...
public:
    ...
    */
    ...
    /*!
     * \brief Take note of the assembled system and (re)build the solver.
     */
    ...
    */
    void prepare(const Matrix& /*M*/, Vector& /*b*/) override
    {
        ...
        // handling needs the owning TpsaMatrix. TpsaNewtonMethod always calls
        // the SparseMatrixAdapter overload.
        OPM_THROW(std::logic_error,
